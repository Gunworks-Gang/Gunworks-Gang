...
---                        `open` / `locked` may each be a function(weapon) -> sprite string,
---                        for weapons whose sprite is resolved dynamically (e.g. from installed parts).
